        ...
        <motion.section
            ...
            <div className="max-w-md mx-auto">
                <form onSubmit={handleSubmit} className="space-y-4">
                    <Input label={t('contact.form.name')} placeholder={t('contact.form.name')} required />
                    <Input label={t('contact.form.email')} placeholder={t('contact.form.email')} type="email" required />
                    <Textarea label={t('contact.form.message')} placeholder={t('contact.form.message')} required />
